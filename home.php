         ...
         <div class="flex flex-wrap items-center">
            <div class="basis-full md:basis-3/5">
               <?php if(has_post_thumbnail()): ?>
                  <?php $latest_post_slide_thumbnail_sizes = wp_get_attachment_image_sizes( get_post_thumbnail_id( get_the_ID() ), 'medium' ); ?>
                  <?php $latest_post_slide_thumbnail_srcset = wp_get_attachment_image_srcset( get_post_thumbnail_id( get_the_ID() ), 'medium' ); ?>
                  <?php $latest_post_slide_thumbnail_url = wp_get_attachment_image_url( get_post_thumbnail_id( get_the_ID() ), 'medium' ); ?>
